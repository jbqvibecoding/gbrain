...
| "process oauth pages", "refine oauth-raw", "process connected service data", `type: oauth-raw` pages pulled by ContextBridge (Gmail/Slack/Notion/GitHub/Calendar auto-pull) | `skills/oauth-ingest/SKILL.md` (router → meeting-ingestion / signal-detector / webhook-transforms / media-ingest) |
